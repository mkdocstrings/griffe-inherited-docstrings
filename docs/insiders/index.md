...
*Griffe Inherited Docstrings* follows the **sponsorware** release strategy, which means
...
*Griffe Inherited Docstrings Insiders* is a private fork of *Griffe Inherited Docstrings*, hosted as
...
repository.
  ...
  [^1]:
    ...
    existing features that must be supported by *Griffe Inherited Docstrings*.
...
*Griffe Inherited Docstrings* and released for general availability, making them available
...
The biggest bottleneck in Open Source is time.[^3]
  ...
  [^3]:
    ...
    The sponsorware model ensures that if you decide to use *Griffe Inherited Docstrings*,
...
<small>
  ...
  your profile and avatar to show your support for *Griffe Inherited Docstrings*.
...
to use *Griffe Inherited Docstrings* locally without having access to Insiders.
Is this still possible?

Yes. Insiders is compatible with *Griffe Inherited Docstrings*. Almost all new features
...
Yes. Whether you're an individual or a company, you may use *Griffe Inherited Docstrings
Insiders* precisely under the same terms as *Griffe Inherited Docstrings*, which are given
