...
*Griffe Inherited Docstrings Insiders* is a compatible drop-in replacement for *Griffe Inherited Docstrings*,
...
*Griffe Inherited Docstrings Insiders* can be installed with `pip` [using SSH][using ssh]:

```bash
pip install git+ssh://git@github.com/pawamoy-insiders/griffe-inherited-docstrings.git
```
...
```bash
pip install git+https://${GH_TOKEN}@github.com/pawamoy-insiders/griffe-inherited-docstrings.git
```
...
Self-hosting the Insiders package makes it possible to depend on *Griffe Inherited Docstrings* normally,
...
with [Twine]:
  ...
  [Github Releases]: https://github.com/pawamoy-insiders/griffe-inherited-docstrings/releases
...
> git clone git@github.com:pawamoy-insiders/griffe-inherited-docstrings
...
>
> Now when running `pip install griffe-inherited-docstrings`,
...
Of course, you can use *Griffe Inherited Docstrings Insiders* directly from `git`:
...
```
pip install -e griffe-inherited-docstrings
```

## Upgrading

When upgrading Insiders, you should always check the version of *Griffe Inherited Docstrings*
